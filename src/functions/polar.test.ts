...
export function test_polar() {
  runIndividualTests([
    ['polar(1+i)', '2^(1/2)*exp(1/4*i*pi)'],
    ['polar(-1+i)', '2^(1/2)*exp(3/4*i*pi)'],
    ['polar(-1-i)', '2^(1/2)*exp(-3/4*i*pi)'],
    ['polar(1-i)', '2^(1/2)*exp(-1/4*i*pi)'],
    ['rect(polar(3+4*i))', '3+4*i'],
    ['rect(polar(-3+4*i))', '-3+4*i'],
    ['rect(polar(3-4*i))', '3-4*i'],
    ['rect(polar(-3-4*i))', '-3-4*i'],
    ['rect(polar((-1)^(1/2)))', 'i'],
    ['rect(polar((-1)^(-5/6)))', '-1/2*i-1/2*3^(1/2)'],
    ['rect(polar((-1)^(-5/a)))', 'cos(5*pi/a)-i*sin(5*pi/a)'],
    ['rect(polar((-1)^(a)))', 'cos(a*pi)+i*sin(a*pi)'],
    [
