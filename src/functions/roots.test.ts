...
export function test_roots() {
  runSequentialTests([
    ...
    // --------------------------------------------
    ['roots(x^3 + x^2 + x + 1)', '[-1,-i,i]'],
    ['roots(2*x^3 + 3*x^2 - 11*x - 6)', '[-3,-1/2,2]'],
    ['roots(x^3 - 7*x^2 + 4*x + 12)', '[-1,2,6]'],
    ...
    ['roots(x^3 + 6x - 20)', '[2,-1-3*i,-1+3*i]'],
    ['roots(x^3 - 6x - 40)', '[4,-2-i*2^(1/2)*3^(1/2),-2+i*2^(1/2)*3^(1/2)]'],
    ['roots(x^3 + x^2 - 5x - 5)', '[-1,-5^(1/2),5^(1/2)]'],
    ...
    ['roots(8*x^3 - 36*x^2 + 54*x - 27)', '3/2'],
    [
    ...
    ['theRoots[1]', '-(-1)^(2/5)*((k/a)^(2/5))^(1/2)'],
    ['theRoots[2] = simplify(theRoots[2])', ''],
    ['theRoots[2]', '-(-1)^(4/5)*((k/a)^(2/5))^(1/2)'],
    ['theRoots[3] = circexp(theRoots[3])', ''],
    ['theRoots[3]', 'exp(1/5*i*pi)*(k/a)^(1/5)'],
    ['theRoots[4] = circexp(theRoots[4])', ''],
    ['theRoots[4]', 'exp(3/5*i*pi)*(k/a)^(1/5)'],
