...
export function test_integral() {
  runIndividualTests([
    ...
    //16
    ['integral(1/(3+x^2),x)-3^(-1/2)*arctan(3^(-1/2)*x)', '0'],
    //17
    ['integral(1/(a-x^2),x)-a^(-1/2)*arctanh(a^(-1/2)*x)', '0'],
    //19
    ['integral(1/sqrt(a-x^2),x)-arcsin(a^(-1/2)*x)', '0'],
    //20
    ['integral(1/sqrt(a+x^2),x)-(log(x+(a+x^2)^(1/2)))', '0'],
    //27
    ['integral(1/(a+b*x),x)-(log(a+b*x)/b)', '0'],
    //28
    ['integral(1/(A+B*X)^2,X)+1/B*1/(A+B*X)', '0'],
    //29
    ['integral(1/(a+b*x)^3,x)+1/2*1/b*(a+b*x)^(-2)', '0'],
    //30
    ['integral(X/(A+B*X),X)+A*B^(-2)*log(A+B*X)-X/B', '0'],
    //31
    ['integral(X/(A+B*X)^2,X)-1/B^2*(log(A+B*X)+A/(A+B*X))', '0'],
    //33
    [
    ...
    //34
    ['integral(X^2/(A+B*X)^2,X)-1/B^3*(A+B*X-2*A*log(A+B*X)-A^2/(A+B*X))', '0'],
    //35
    [
    ...
    //37
    ['integral(1/X*1/(A+B*X),X)+1/A*log((A+B*X)/X)', '0'],
    //38
    ['integral(1/X*1/(A+B*X)^2,X)-1/A*1/(A+B*X)+1/A^2*log((A+B*X)/X)', '0'],
    //39
    [
    ...
    //40
    ['integral(1/X^2*1/(A+B*X),X)+1/(A*X)-B/A^2*log((A+B*X)/X)', '0'],
    //41
    [
    ...
    //60
    ['integral(1/(2+3*X^2),X)-1/sqrt(6)*arctan(1/2*X*sqrt(6))', '0'],
    ['integral(1/(-2-3*X^2),X)-1/sqrt(6)*arctan(-1/2*X*sqrt(6))', '0'],
    //61
    [
    ...
    //63
    ['integral(X/(A+B*X^2),X)-1/2*1/B*log(A+B*X^2)', '0'],
    //64
    ['integral(X^2/(A+B*X^2),X)-X/B+A/B*integral(1/(A+B*X^2),X)', '0'],
    //65
    [
    ...
    //70
    ['integral(1/X*1/(A+B*X^2),X)-1/2*1/A*log(X^2/(A+B*X^2))', '0'],
    //71
    ['integral(1/X^2*1/(A+B*X^2),X)+1/(A*X)+B/A*integral(1/(A+B*X^2),X)', '0'],
    //74
    [
    ...
    //76
    ['integral(X^2/(A+B*X^3),X)-1/3*1/B*log(A+B*X^3)', '0'],
    ...
    //124
    ['integral(sqrt(A+B*X),X)-2/3/B*sqrt((A+B*X)^3)', '0'],
    //125
    ['integral(X*sqrt(A+B*X),X)+2*(2*A-3*B*X)*sqrt((A+B*X)^3)/15*B^(-2)', '0'],
    //126
    [
    ...
    //131
    ['integral(1/sqrt(A+B*X),X)-2*sqrt(A+B*X)/B', '0'],
    //132
    ['integral(X/sqrt(A+B*X),X)+2/3*(2*A-B*X)*sqrt(A+B*X)/B^2', '0'],
    //133
    [
    ...
    //136
    ['integral(1/X*1/sqrt(-2+B*X),X)-2/sqrt(2)*arctan(sqrt((-2+B*X)/2))', '0'],
    //137
    [
    ...
    //156
    ['integral(sqrt(X^2+A),X)-1/2*(X*sqrt(X^2+A)+A*log(X+sqrt(X^2+A)))', '0'],
    //157
    ['integral(1/sqrt(X^2+A),X)-log(X+sqrt(X^2+A))', '0'],
    //158
    ['integral(1/X*1/sqrt(X^2-2),X)-arcsec(X/sqrt(2))/sqrt(2)', '0'],
    //159
    [
    ...
    //161
    ['integral(sqrt(X^2-2)/X,X)-sqrt(X^2-2)+sqrt(2)*arcsec(X/sqrt(2))', '0'],
    //162
    ['integral(X/sqrt(X^2+A),X)-sqrt(X^2+A)', '0'],
    //163
    ...
    //169
    ['integral(X^3*sqrt(X^2+7),X)-(1/5*X^2-2/15*7)*sqrt((X^2+7)^3)', '0'],
    //170
    [
    ...
    //172
    ['integral(X^3/sqrt(X^2+A),X)-1/3*sqrt((X^2+A)^3)+A*sqrt(X^2+A)', '0'],
    //173
    ['integral(1/X^2*1/sqrt(X^2+A),X)+sqrt(X^2+A)/A/X', '0'],
    //174
    [
...
-1/5*(7^2)*sqrt((X^2-7^2)^5)`,
    ...
    //197
    ['integral(1/(X+A)/sqrt(X^2-A^2),X)-sqrt(X^2-A^2)/A/(X+A)', '0'],
    [
      'simplify(1/(X+A)/sqrt(X^2-A^2)-d(integral(1/(X+A)/sqrt(X^2-A^2),X),X))',
      '0',
    ],
    //200
    ['integral(sqrt(7-X^2),X)-1/2*(X*sqrt(7-X^2)+7*arcsin(X/sqrt(7)))', '0'],
    //201
    ['integral(1/sqrt(7-X^2),X)-arcsin(X/sqrt(7))', '0'],
    //202
    [
...
+1/3*sqrt((7-X^2)^3)/7/X^3`,
    ...
    //290
    ['integral(sin(A*X),X)+cos(A*X)/A', '0'],
    //291
    ['integral(cos(A*X),X)-sin(A*X)/A', '0'],
    //292
    ['integral(tan(A*X),X)+log(cos(A*X))/A', '0'],
    //293
    ['integral(1/tan(A*X),X)-log(sin(A*X))/A', '0'],
    //294
    ['integral(1/cos(A*X),X)-log(tan(pi/4+A*X/2))/A', '0'],
    //295
    ['integral(1/sin(A*X),X)-log(tan(A*X/2))/A', '0'],
    //296
    ['integral(sin(A*X)^2,X)-X/2+sin(2*A*X)/(4*A)', '0'],
    //297
    ['integral(sin(A*X)^3,X)+cos(A*X)*(sin(A*X)^2+2)/(3*A)', '0'],
    //298
    ['integral(sin(A*X)^4,X)-3/8*X+sin(2*A*X)/(4*A)-sin(4*A*X)/(32*A)', '0'],
    //302
    ['integral(cos(A*X)^2,X)-X/2-sin(2*A*X)/(4*A)', '0'],
    //303
    ['integral(cos(A*X)^3,X)-sin(A*X)*(cos(A*X)^2+2)/(3*A)', '0'],
    //304
    ['integral(cos(A*X)^4,X)-3/8*X-sin(2*A*X)/(4*A)-sin(4*A*X)/(32*A)', '0'],
    //308
    ['integral((1/sin(A*X))^2,X)+1/A*1/tan(A*X)', '0'],
    //312
    ['integral((1/cos(A*X))^2,X)-tan(A*X)/A', '0'],
    //318
    ['integral(sin(A*X)*cos(A*X),X)-sin(A*X)^2/(2*A)', '0'],
    //320
    ['integral(sin(A*X)^2*cos(A*X)^2,X)+sin(4*A*X)/(32*A)-X/8', '0'],
    //326
    ['integral(sin(A*X)/cos(A*X)/cos(A*X),X)-1/(A*cos(A*X))', '0'],
    //327
    ['integral(sin(A*X)^2/cos(A*X),X)+sin(A*X)/A-log(tan(pi/4+A*X/2))/A', '0'],
    //328
    ['integral(cos(A*X)/sin(A*X)^2,X)+1/(A*sin(A*X))', '0'],
    //329
    ['integral(1/sin(A*X)/cos(A*X),X)-log(tan(A*X))/A', '0'],
    //330
    ['integral(1/sin(A*X)/cos(A*X)^2,X)-(1/cos(A*X)+log(tan(A*X/2)))/A', '0'],
    //332
    [
    ...
    //333
    ['integral(1/sin(A*X)^2/cos(A*X)^2,X)+2/(A*tan(2*A*X))', '0'],
    //335
    ['integral(sin(A+B*X),X)+cos(A+B*X)/B', '0'],
    //336
    ['integral(cos(A+B*X),X)-sin(A+B*X)/B', '0'],
    //337+
    ['integral(1/(1+sin(A*X)),X)+tan(pi/4-A*X/2)/A', '0'],
    //337b+
    ['integral(1/(B+B*sin(A*X)),X)+tan(pi/4-A*X/2)/A/B', '0'],
    //337-
    ['integral(1/(1-sin(A*X)),X)-tan(pi/4+A*X/2)/A', '0'],
    //337b-
    ['integral(1/(B-B*sin(A*X)),X)-tan(pi/4+A*X/2)/A/B', '0'],
    //338
    ['integral(1/(1+cos(A*X)),X)-tan(A*X/2)/A', '0'],
    //339
    ['integral(1/(1-cos(A*X)),X)+1/(A*tan(A*X/2))', '0'],
    //340
    [
    ...
    //389
    ['x*sin(A*x)-d(integral(x*sin(A*x)))', '0'],
    //390
    ['x^2*sin(A*x)-d(integral(x^2*sin(A*x)))', '0'],
    //393
    ['x*cos(A*x)-d(integral(x*cos(A*x)))', '0'],
    //394
    ['x^2*cos(A*x)-d(integral(x^2*cos(A*x)))', '0'],
    //441
    ['integral(arcsin(A*X),X)-X*arcsin(A*X)-sqrt(1-A^2*X^2)/A', '0'],
    //442
    ['integral(arccos(A*X),X)-X*arccos(A*X)+sqrt(1-A^2*X^2)/A', '0'],
    //443
    ['integral(arctan(A*X),X)-X*arctan(A*X)+log(1+A^2*X^2)/(2*A)', '0'],
    //485
    ['integral(log(X),X)-X*log(X)+X', '0'],
    //485a
    ['integral(log(A*X),X)-X*log(A*X)+X', '0'],
    //486
    ['integral(X*log(X),X)-1/2*X^2*log(X)+1/4*X^2', '0'],
    //486a
    ['integral(X*log(A*X),X)-1/2*X^2*log(A*X)+1/4*X^2', '0'],
    //487
    ['integral(X^2*log(A*X),X)-1/3*X^3*log(A*X)+X^3/9', '0'],
    //489
    ['integral(log(X)^2,X)-X*log(X)^2+2*X*log(X)-2*X', '0'],
    //493
    ['integral(1/X*1/log(A*X),X)-log(log(A*X))', '0'],
    //499
    ['integral(log(A*X+B),X)-(A*X+B)*log(A*X+B)/A+X', '0'],
    //500
    ['integral(log(A*X+B)/X^2,X)-A*log(X)/B+(A*X+B)*log(A*X+B)/B/X', '0'],
    //554
    ['integral(sinh(X),X)-cosh(X)', '0'],
    //555
    ['integral(cosh(X),X)-sinh(X)', '0'],
    //556
    ['integral(tanh(X),X)-log(cosh(X))', '0'],
    //560
    ['integral(X*sinh(X),X)-X*cosh(X)+sinh(X)', '0'],
    //562
    ['integral(X*cosh(X),X)-X*sinh(X)+cosh(X)', '0'],
    //566
    ['integral(sinh(X)^2,X)-sinh(2*X)/4+X/2', '0'],
    //569
    ['integral(tanh(X)^2,X)-X+tanh(X)', '0'],
    //572
