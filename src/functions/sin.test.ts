...
export function test_sin() {
  ...
  runSequentialTests([
    ...
    ['f(45,sqrt(2)/2)', '1.000000...'],
    // this should really be 1.0 , however
    // we have errors doing the calculations so
    // we don't get to that exact 1.0 float
    ['f(135,sqrt(2)/2)', '1.000000...'],
    ['f(225,-sqrt(2)/2)', '1.0'],
    // this should really be 1.0 , however
    // we have errors doing the calculations so
    // we don't get to that exact 1.0 float
    ['f(315,-sqrt(2)/2)', '1.000000...'],
    ['f(-45,-sqrt(2)/2)', '1.0'],
    ['f(-135,-sqrt(2)/2)', '1.0'],
    // this should really be 1.0 , however
    // we have errors doing the calculations so
    // we don't get to that exact 1.0 float
    ['f(-225,sqrt(2)/2)', '1.000000...'],
    ['f(-315,sqrt(2)/2)', '1.0'],
    ['f(30,1/2)', '1.0'],
    ['f(150,1/2)', '1.0'],
    // this should really be 1.0 , however
    ...
    // we have errors doing the calculations so
    // we don't get to that exact 1.0 float
    ['f(60,sqrt(3)/2)', '1.000000...'],
    ['f(120,sqrt(3)/2)', '1.0'],
    // this should really be 1.0 , however
    // we have errors doing the calculations so
    // we don't get to that exact 1.0 float
    ['f(240,-sqrt(3)/2)', '1.000000...'],
    ['f(300,-sqrt(3)/2)', '1.0'],
    // this should really be 1.0 , however
    // we have errors doing the calculations so
    // we don't get to that exact 1.0 float
