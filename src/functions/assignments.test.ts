...
export function test_assignments() {
  runSequentialTests([
    ...
    ['0=0', 'Stop: symbol assignment: error in symbol'],
    ['1=2', 'Stop: symbol assignment: error in symbol'],
    ['3=a', 'Stop: symbol assignment: error in symbol'],
    // ------------------------------------------
    ...
    ['("hey")(a)', 'Stop: expected function, found string instead.'],
    ['"hey"(a)', 'Stop: expected function, found string instead.'],
    ...
    ['1[2] = 3', 'Stop: indexed assignment: expected a symbol name'],
    [
      'undefinedVar[1] = 2',
    ...
    ['f(x) = x + 1', ''],
    ['g = f', ''],
    ['lookup(f)', 'function (x) -> x+1'],
    ['lookup(g)', 'function (x) -> x+1'],
    ['f(x,y) = x + 2', ''],
    ['lookup(f)', 'function (x y) -> x+2'],
    ['g(3)', '4'],
    ['f(3,0)', '5'],
    ['f = quote(1+1)', ''],
    ['g = f', ''],
    ...
    // ----------------------
    ['a = a+1', ''],
    ['a', 'Stop: recursive evaluation of symbols: a -> a'],
    // ----------------------
    ['a := b', ''],
    ['b := c', ''],
    ['c := a', ''],
    ['b', 'Stop: recursive evaluation of symbols: b -> c -> a -> b'],
    // ----------------------
