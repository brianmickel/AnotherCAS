...
export function test_power() {
  runIndividualTests([
    ...
    ['(1+i)^(-1/2)', '-(-1)^(7/8)/(2^(1/4))'],
    ['(1+i)^(0.5)', '1.098684...+0.455090...*i'],
    ['(1+i)^(-0.5)', '0.776887...-0.321797...*i'],
    ...
    ['exp(i*7*pi/2)', '-i'],
    ['exp(i*4*pi)', '1'],
    ['exp(A+i*pi/2)', 'i*exp(A)'],
    ['exp(A+i*pi)', '-exp(A)'],
    ['exp(A+i*3*pi/2)', '-i*exp(A)'],
    ['exp(A+i*2*pi)', 'exp(A)'],
    ['exp(A+i*5*pi/2)', 'i*exp(A)'],
    ['exp(A+i*3*pi)', '-exp(A)'],
