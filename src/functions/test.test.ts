...
export function test_test() {
  ...
  runSequentialTests([
    ['x = -1', ''],
    ['test(x<1,-x-4,3<=x,x*x+7,120/x+5)', '-3'],
    ['x = 3', ''],
    ['test(x<1,-x-4,3<=x,x*x+7,120/x+5)', '16'],
    ['x = 2', ''],
    ['test(x<1,-x-4,3<=x,x*x+7,120/x+5)', '65'],
    ['x=quote(x)', ''],
  ]);
  ...
  runIndividualTests([
    ...
    ['[0,0]==0', '1'],
    ['[1,2]==[1,2]', '1'],
    ['[1,2]==[a,2]', 'testeq([1,2],[a,2])'],
    ['[1,2]==[3,4]', '0'],
    ['[1,2]==[cos(x)^2 + sin(x)^2,2]', '1'],
    ['1<sqrt(3)', '1'],
    ['cos(x)^2 + sin(x)^2 == 1', '1'],
    ['cos(x)^2 + sin(x)^2 >= 1', '1'],
    ['cos(x)^2 + sin(x)^2 <= 1', '1'],
