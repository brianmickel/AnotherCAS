...
export function test_mixedprint() {
  runSequentialTests([
    ...
    ['1111.0 * 1111.0', '1234321.0'],
    ['11111111 * 11111111.0', '123456787654321.0'],
    ['11111111.0 * 11111111', '123456787654321.0'],
    ['11111111.0 * 11111111.0', '123456787654321.0'],
    // unfortunately using Numbers
    // at some point we hit the precision
    ['111111111 * 111111111.0', '12345678987654320.0'],
    // unfortunately using Numbers
    // at some point we hit the precision
    ['111111111.0 * 111111111', '12345678987654320.0'],
    // unfortunately using Numbers
    // at some point we hit the precision
    ...
    ['maxFixedPrintoutDigits', '20'],
    ['1.0*10^(-15)', '0.000000000000001'],
    ['printhuman', '0.000000000000001'],
    ...
    ['1.0*10^(-15)', '1.0*10^(-15)'],
    ['printhuman', '1.0*10^(-15)'],
    ['printcomputer', '1.0*10^(-15)'],
    ['printlatex', '1.0\\mathrm{e}{-15}'],
    ['printlist', '1.0*10^(-15)'],
    ...
    ['printhuman', '-1/2 2^(1/2)'],
    ['printcomputer', '-1/2*2^(1/2)'],
    ['printlatex', '-\\frac{\\sqrt{2}}{2}'],
    ['printlist', '(multiply -1/2 (power 2 1/2))'],
    ['printlist(a+b)\nprintlist(c+d)', '(add a b)(add c d)'],
    ['print2dascii', '   1   1/2\n- --- 2\n   2'],
    ['last2dasciiprint', '"   1   1/2\n- --- 2\n   2"'],
    ...
    ['print2dascii(x^(1/a))', ' 1/a\nx'],
    ['print2dascii(x^(a/b))', ' a/b\nx'],
    ['print2dascii(x^(a/2))', ' 1/2 a\nx'],
    ['print2dascii(x^(1/(a+b)))', ' 1/(a + b)\nx'],
    // ------------------------------------------
