...
+ 3 exp(-1/3 r + i phi) cos(theta)^3 / sin(theta))`,
    ...
    ['simplify(d(arctan(y/x),y))', 'x/(x^2+y^2)'],
    ['simplify(d(arctan(y/x),x))', '-y/(x^2+y^2)'],
    ['simplify(1-sin(x)^2)', 'cos(x)^2'],
    ['simplify(1-cos(x)^2)', 'sin(x)^2'],
    ['simplify(sin(x)^2-1)', '-cos(x)^2'],
    ...
    ['simplify(condense((n+1)*n!))-(n+1)!', '0'],
    ['simplify(1/((n+1)*n!))-1/(n+1)!', '0'],
    ['simplify((n+1)!/n!)-n-1', '0'],
    ['simplify(n!/(n+1)!)-1/(n+1)', '0'],
    ['simplify(binomial(n+1,k)/binomial(n,k))', '(1+n)/(1-k+n)'],
    ['simplify(binomial(n,k)/binomial(n+1,k))', '(1-k+n)/(1+n)'],
  ]);

  runSequentialTests([
    ['F(nn,kk)=kk*binomial(nn,kk)', ''],
    ['simplify((F(n,k)+F(n,k-1))/F(n+1,k))-n/(n+1)', '0'],
    ['F=quote(F)', ''],
  ]);

  runIndividualTests([
    ['simplify((n+1)/(n+1)!)-1/n!', '0'],
  ...
  runIndividualTests([
    ['simplify((6 - 4*2^(1/2))^(1/2))', '2-2^(1/2)'],
    ['4-4*(-1)^(1/3)+4*(-1)^(2/3)', '0'],
    ['simplify(4-4*(-1)^(1/3)+4*(-1)^(2/3))', '0'],
    // this requires some simplification to be
    // further done after the de-nesting
    ['simplify(14^(1/2) - (16 - 4*7^(1/2))^(1/2))', '2^(1/2)'],
    ['simplify(-(2^(1/2)*(-1+7^(1/2)))+2^(1/2)*7^(1/2))', '2^(1/2)'],
    ['simplify((9 + 6*2^(1/2))^(1/2))', '3^(1/2)*(1+2^(1/2))'],
    ['simplify((7 + 13^(1/2))^(1/2))', '(1+13^(1/2))/(2^(1/2))'],
    // two nested radicals at the same time
    ['simplify((17 + 12*2^(1/2))^(1/2) + (17 - 12*2^(1/2))^(1/2))', '6'],
    ['simplify((2 + 3^(1/2))^(1/2))', '(1+3^(1/2))/(2^(1/2))'],
    ['simplify((1/2 + (39^(1/2)/16))^(1/2))', '(3^(1/2)+13^(1/2))/(4*2^(1/2))'],
    ...
    ['simplify((-108+108*(-1)^(1/2)*3^(1/2))^(1/3))', '6*(-1)^(2/9)'], // also: "(-108+108*i*3^(1/2))^(1/3)" is a possible result
    // you can take that 4 out of the radical
    // but other than that there is no
    // "sum or radicals" form of this
    ['simplify((-4+4*(-1)^(1/2)*3^(1/2))^(1/3))', '2*(-1)^(2/9)'], // also: "(-4+4*i*3^(1/2))^(1/3)" is a possible result
    ...
    ['simplify((1 +3^(1/2)/2)^(1/2) + (1 -3^(1/2)/2)^(1/2))', '3^(1/2)'],
    ['simplify((1 +3^(1/2)/2)^(1/2))', '1/2*(1+3^(1/2))'],
    // not quite perfect as there is a radical at the
    // denominator, but the de-nesting happens.
    ['simplify(((1 +39^(1/2)/8)/2)^(1/2))', '(3^(1/2)+13^(1/2))/(4*2^(1/2))'],
    ...
    ['simplify((3 - 2*2^(1/2))^(1/2))', '-1+2^(1/2)'],
    ['simplify((27/2+27/2*(-1)^(1/2)*3^(1/2))^(1/3))', '3*(-1)^(1/9)'], // also good: (27/2+27/2*i*3^(1/2))^(1/3)
    // this nested radical is also equal to
    // (-1)^(1/9)
    // but there is no "sum of radicals" form
    // for this.
    ['simplify((1/2+1/2*(-1)^(1/2)*3^(1/2))^(1/3))', '(-1)^(1/9)'], // also good: (1/2+1/2*i*3^(1/2))^(1/3)
    ['simplify((2 + 5^(1/2))^(1/3))', '1/2*(1+5^(1/2))'],
    ['simplify((-3 + 10*3^(1/2)*i/9)^(1/3))', '1+2/3*i*3^(1/2)'],
    ['simplify((1-3*x^2+3*x^4-x^6)^(1/2))', '(-x^6+3*x^4-3*x^2+1)^(1/2)'],
    [
      'simplify(subst((-1)^(1/2),i,(-3 + 10*3^(1/2)*i/9)^(1/3)))',
      '1+2/3*i*3^(1/2)',
    ],
    ['simplify(rationalize(-3 + 10*3^(1/2)*i/9)^(1/3))', '1+2/3*i*3^(1/2)'],
    ...
    ['simplify((-1)^(1/6) - (-1)^(5/6))', '3^(1/2)'],
    ['simplify((7208+2736*5^(1/2))^(1/3))', '17+3*5^(1/2)'],
    ['simplify((901+342*5^(1/2))^(1/3))', '1/2*(17+3*5^(1/2))'],
    [
    ...
    ['simplify((1)^(-6/a))', '1'],
    ['simplify((1)^(6/a))', '1'],
    ['simplify(transpose(A)*transpose(x))', 'transpose(A*x)'],
    ['simplify(inner(transpose(A),transpose(x)))', 'transpose(inner(x,A))'],
    // ---------------------------------------------
    // checking that simplify doesn't make incorrect
    // simplifications
    ['simplify(sqrt(-1/2 -1/2 * x))', '(-1/2*x-1/2)^(1/2)'],
    ['simplify(sqrt(x*y))', '(x*y)^(1/2)'],
    ['simplify(sqrt(1/x))', '(1/x)^(1/2)'],
    ['simplify(sqrt(x^y))', '(x^y)^(1/2)'],
    ['simplify(sqrt(x)^2)', 'x'],
    ...
    ['simplify((x^2+7x+6)/(x^2-5x-6))', '(x+6)/(x-6)'],
    ['simplify(x*(x+1)/(x+1)+1)', 'x+1'],
    ['simplify(x*(x+1)/(x+1))', 'x'],
    ['simplify((x^2+3x)/(x^2+5x))', '(x+3)/(x+5)'],
    ['simplify((6x+20)/(2x+10))', '(3*x+10)/(x+5)'],
    ['simplify((x^3-3x^2)/(4x^2-5x))', 'x*(x-3)/(4*x-5)'],
    ['simplify((x^2-9)/(x^2+5x+6))', '(x-3)/(x+2)'],
    ['simplify((x^2-3x+2)/(x^2-1))', '(x-2)/(x+1)'],
    ['simplify((x^2-2x-15)/(x^2+x-6))', '(x-5)/(x-2)'],
    ['simplify(10x^3/(2x^2-18x))', '5*x^2/(x-9)'],
    ['simplify(6x^2/(12x^4-9x^3))', '1/(x*(2*x-3/2))'],
    ['simplify(((3-x)*(x-1))/((x-3)*(x+1)))', '(-x+1)/(x+1)'],
    ['simplify(((x-2)*(x-5))/((2-x)*(x+5)))', '(-x+5)/(x+5)'],
    ['simplify((15-10x)/(8x^3-12x^2))', '-5/(4*x^2)'],
    ['simplify(3x/(15x^2-6x))', '1/(5*x-2)'],
    ['simplify((3x^3-15x^2+12x)/(3x-3))', 'x*(x-4)'],
    ['simplify((6x^2-12x)/(6x-3x^2))', '-2'],
    ['simplify((2x^2+13x+20)/(2x^2+17x+30))', '(x+4)/(x+6)'],
    ['simplify((x^4+8x^2+7)/(3x^5-3x))', '(x^2+7)/(3*x*(x^2-1))'],
    ['simplify((x^2+8x*k+16*k^2)/(x^2-16k^2))', '(x+4*k)/(x-4*k)'],
    ['simplify((x^2-2x-8)/(x^2-9x+20))', '(x+2)/(x-5)'],
    ['simplify((x^2-25)/(5x-x^2))', '-1-5/x'],
    ['simplify((x^7+2x^6+x^5)/(x^3*(x+1)^8))', 'x^2/((x+1)^6)'],
    ['simplify((x^2+2*x+1)/((x+1)^8))', '1/((x+1)^6)'],
    [
      'simplify(((x^2-5x-14)/(x^2-3x+2))*((x^2-4)/(x^2-14x+49)))',
      '(x+2)^2/((x-7)*(x-1))',
    ],
    ['simplify(((x^2-9)/(x^2+5x+6))/((3-x)/(x+2)))', '-1'],
    ['simplify((x^2+5x+4)/((x^2-1)/(x+5)))', '(x^2+9*x+20)/(x-1)'],
    ['simplify((x^2-6x-7)/(x^2-10x+21))', '(x+1)/(x-3)'],
    ['simplify((x^2+6x+9)/(x^2-9))', '(x+3)/(x-3)'],
    ['simplify((2x^2-x-28)/(20-x-x^2))', '(-2*x-7)/(x+5)'],
    [
    ...
    ['simplify(((x^2-2x-8)/(2x^2-8x-24))/((x^2-9x+20)/(x^2-11x+30)))', '1/2'],
    ['simplify((3/(x+1))/((x+4)/(x^2+11x+10)))', '3*(x+10)/(x+4)'],
    ['simplify((x^3+10x^2)/(x^2+6x-40))', 'x^2/(x-4)'],
    ['simplify((x^2+18x+72)/(2x^2+11x-6))', '(x+12)/(2*x-1)'],
    ['simplify((x^2-3x-28)/(49-x^2))', '(-x-4)/(x+7)'],
    ['simplify((6x^2+13x+5)/(3x^2+26x+35))', '(2*x+1)/(x+7)'],
    ['simplify((-x^2+10x-9)/(-x^2+6x+27))', '(x-1)/(x+3)'],
    ['simplify((x-6)*(x^3+x^2-20x)/(x^4-12x^3+36x^2))', '(1+x-20/x)/(x-6)'],
    // somewhat strange simplification but it's correct
    [
      'simplify(((4x^3-x^2-3x)/(x^2-10x+25))*((10+3x-x^2)/(x^4-x^3)))',
      '(-4-6/(x^2)-11/x)/(x-5)',
    ],
    ['simplify(((x^2+5x-24)/(x^2-5x+4))/((x^2+x-12)/(x-1)))', '(x+8)/(x^2-16)'],
    [
    ...
    ['simplify((5x^2-18x-8)/((x-4)/(x+6)))', '5*x^2+32*x+12'],
    ['simplify((2/(x+4))/((6x^3+17x^2)/(x^2+3x-4)))', '(x-1)/(x^2*(3*x+17/2))'],
    ...
    ['simplify((2x/(x^2-9))-(1/(x+3))-(2/(x-3)))', '-1/(x-3)'],
    ['simplify((4/(x+2)-(1/x)+1)*(x+2)*x)', 'x^2+5*x-2'],
    ['simplify(((3/(x-4))+x/(2x+7))*(x-4)*(2x+7))', 'x^2+2*x+21'],
    ['simplify((x/(x^2+12x+36))-((x-8)/(x+6)))', '(-x^2+3*x+48)/((x+6)^2)'],
    [
    ...
    ['simplify((x+10)/((3x+8)^3)+x/((3x+8)^2))', '(3*x^2+9*x+10)/((3*x+8)^3)'],
    ['simplify(2/(3x^2)-1/(4x^7)+7/(6x^3))', '(2/3*x^5+7/6*x^4-1/4)/(x^7)'],
    ['simplify(2x/(x+9)-(x-1)/(x))', '-1+1/x+2*x/(x+9)'],
    ['simplify((x+1)/(x-1)+6/(x-7))', '(x^2-13)/((x-7)*(x-1))'],
    ['simplify(9/(x^2-4)-7x/(x^2-4x+4))', '(-7*x^2-5*x-18)/((x-2)^2*(x+2))'],
    [
    ...
    // could be cleaner but it's correct
    ['simplify(3/(6x-x^2)-x/(x^2-5x-6))', '(-3-x-3/x)/((x-6)*(x+1))'],
    // could be cleaner but it's correct
    [
      'simplify(3/(x^2)+(x+9)/(x^2+5x)-2/(x^2+10x+25))',
      '(15+x+75/(x^2)+75/x)/((x+5)^2)',
    ],
    ['simplify(1/(x+1)-2/((x+1)^2)-3/((x+1)^3))', '(x^2-4)/((x+1)^3)'],
  ]);
}
